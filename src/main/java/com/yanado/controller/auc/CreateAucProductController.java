...
public class CreateAucProductController {
	...
	@RequestMapping(value = "/product/auc/create", method = RequestMethod.GET)
	public String form() {
		return "auc/product";
	}

	@RequestMapping(value = "/product/auc/create", method = RequestMethod.POST)
	...
	@RequestMapping("/product/auc/find")
	public ModelAndView findProduct() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("auc/productList");
